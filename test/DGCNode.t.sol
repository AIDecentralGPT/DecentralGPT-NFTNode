...
import "../src/DGCNode.sol";
import {ERC1967Proxy} from "@openzeppelin/contracts/proxy/ERC1967/ERC1967Proxy.sol";

contract DLCNodeTest is Test {
    DGCNode public dlcNode;
    ...
    function setUp() public {
        ...
        ERC1967Proxy proxy = new ERC1967Proxy(address(new DGCNode()), "");
        DGCNode(address(proxy)).initialize(owner);
        dlcNode = DGCNode(address(proxy));
