...
contract DGCNode is Initializable, ERC1155Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    mapping(uint256 => LevelConfig) public levels; // Level configurations (1-9)
    ...
    function setLevelConfigs() internal onlyOwner {
        levels[1] = LevelConfig(40000, 0);
        levels[2] = LevelConfig(20000, 0);
        levels[3] = LevelConfig(13300, 0);
        levels[4] = LevelConfig(9120, 0);
        levels[5] = LevelConfig(6400, 0);
        levels[6] = LevelConfig(4500, 0);
        levels[7] = LevelConfig(3000, 0);
        levels[8] = LevelConfig(2000, 0);
        levels[9] = LevelConfig(1680, 0);
    }
